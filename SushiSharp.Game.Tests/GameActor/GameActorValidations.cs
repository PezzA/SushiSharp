...
public class GameActorValidations : TestKit
{
    ...
    public void GameActor_DoesNotExceedMaxPlayers()
    {
        ...
        var gameActorProps = Props.Create(() => new Actors.Game.GameActor(new RiggedCardShuffler(new List<Card>()), writerProbe, creatorPlayer, gameId ));
